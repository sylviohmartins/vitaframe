...
const required = [
  ...
  'docs/design/design-system.md', 'docs/design/brand.md', 'docs/design/ux-architecture.md', 'docs/design/accessibility.md', 'docs/design/visual-qa.md',
  ...
  'assets/brand/favicon.svg', 'assets/brand/favicon.ico', 'assets/brand/apple-touch-icon.png',
  'assets/brand/icon-192.png', 'assets/brand/icon-512.png',
  'assets/brand/icon-maskable-192.png', 'assets/brand/icon-maskable-512.png', 'assets/brand/og-image.png',
...
for (const file of tracked) {
  ...
  if (file.endsWith('.tmp')) failures.push(`${file}: temporary files must not be tracked`);
